            ...
            <tr>
                ...
                <td>
                    ...
                    <td style="text-align:left;">
                        <?php if(mcv('quick.adv.view|quick.adv.edit')) { ?>
	                        <a href="<?php  echo webUrl('quick/adv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm btn-op btn-operation">
                                 <span data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php if(mcv('quick.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
                                    <?php if(mcv('quick.adv.edit')) { ?>
