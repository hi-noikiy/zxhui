...
<div class="page-content">
    <form action="./merchant.php" method="get" class="form-horizontal"  id="form1">
       ...
       <?php if(mcv('statistics.order.export')) { ?>
    ...
    <?php  } else { ?>
        <table class="table ">
            ...
            <tr class="trorder">
                ...
                <td colspan="7"><span style="font-weight: bold"><?php  echo date('Y-m-d H:i',$row['createtime'])?>  </span><?php  echo $row['ordersn'];?> </td>
            ...
            <tr class="trbody" style="border: 1px solid #efefef;">
                ...
                <td style="text-align:right;border-left:none;"> <?php  echo $g['realprice']/$g['total']?><br/>x<?php  echo $g['total'];?><br/></td>
