...
<div class='page-header'>
    当前位置：<span class="text-primary"> 优惠券分类  <?php if(mcv('sale.coupon.category.edit')) { ?><small>拖动可以排序</small><?php  } ?></span>
</div>
                ...
                <tr>
                    ...
                    <td>
                          <?php if(mcv('sale.coupon.category.delete')) { ?>
                          	<a href="<?php  echo merchUrl('sale/coupon/category/delete', array('id' => $row['id']))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm btn-op btn-operation" data-confirm="确认删除此分类?">
