...
<form action="" method="post" class="article-post" enctype="multipart/form-data">
	...
	<div class="form-group">
        <label for="" class="control-label col-sm-2">摘要</label>
        <div class="form-controls col-sm-8">
            <textarea name="abstract" rows="4" cols="80"><?php  echo $list['abstract'];?></textarea>
        </div>
    </div>
	...
	<?php  } else { ?>
	<input type="hidden" name="url" value="<?php  echo str_replace('&act=newsadd','',$_W['siteurl'])?>" />
	<?php  } ?>
</form>
