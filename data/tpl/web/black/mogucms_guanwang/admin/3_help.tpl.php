...
<div id="js-wesite-article-display">
    <div class="pull-right menu-content-tips">
        <a href="<?php  echo $_W['siteurl'];?>&act=category" class="btn btn-primary we7-padding-horizontal">分类管理</a>
		<a href="<?php  echo $_W['siteurl'];?>&act=newsadd" class="btn btn-primary we7-padding-horizontal">添加帮助</a>
    </div>
    <br />
    ...
    <table class="table we7-table table-hover article-list vertical-middle">
        ...
        <tr>
            ...
            <td class="text-left"><?php  echo $list['categoryname'];?></td>
            <td>
