...
<div class="page-content">
    <form action="./index.php" method="get" class="form-horizontal form-search" role="form">
        ...
        <input type="hidden" name="r"  value="cycelbuy.comment" />

        <div class="page-toolbar">
            <div class="col-sm-2">
                <?php if(cv('shop.comment.add')) { ?>
                    <a class='btn btn-primary btn-sm' href="<?php  echo webUrl('cycelbuy/comment/add')?>"><i class='fa fa-plus'></i> 添加虚拟评论</a>
                <?php  } ?>
            </div>
    ...
    <?php  } else { ?>
        <div class="page-table-header">
            ...
            <div class="btn-group">
                ...
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php  echo webUrl('cycelbuy/comment/delete')?>">
            ...
            <tbody>
                <?php  if(is_array($list)) { foreach($list as $row) { ?>
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-op btn-operation'  href="<?php  echo webUrl('cycelbuy/comment/post', array('id' => $row['id'], 'type' => 1))?>">
                            ...
                            <?php  if(!empty($row['openid'])) { ?>
                                ...
                                <a class='btn btn-op btn-operation'  href="<?php  echo webUrl('cycelbuy/comment/post', array('id' => $row['id']))?>">
                            ...
                            <?php  } else { ?>
                                ...
                                <a class='btn btn-op btn-operation'  href="<?php  echo webUrl('cycelbuy/comment/edit', array( 'id' => $row['id']))?>">
                            ...
                            <?php  } ?>
                            <?php if(cv('shop.comment.add')) { ?>
                                <a class='btn btn-op btn-operation'  href="<?php  echo webUrl('cycelbuy/comment/add', array( 'goodsid' => $row['goodsid']))?>">
                            ...
                            <?php  } ?>
                            <?php if(cv('shop.comment.delete')) { ?>
                                <a class='btn btn-op btn-operation'  data-toggle='ajaxRemove'   href="<?php  echo webUrl('cycelbuy/comment/delete', array('id' => $row['id']))?>" data-confirm="确认删除此评价吗？">
