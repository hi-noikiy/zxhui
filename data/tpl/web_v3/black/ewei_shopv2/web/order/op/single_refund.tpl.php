                ...
                <div class='row'>
                    ...
                    <div class="col-sm-9 col-xs-12">
                            <div class="form-control-static">
                                ...
                                快递单号: <?php  echo $refund['expresssn'];?> &nbsp;&nbsp;&nbsp;<a class='op' data-toggle="ajaxModal" href="<?php  echo webUrl('util/express', array('id' => $item['ordergoodsid'],'express'=>$refund['express'],'expresssn'=>$refund['expresssn']))?>">查看物流</a><br>
                ...
                <div class='row'>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class="form-control-static">
                            ...
                            快递单号: <?php  echo $refund['rexpresssn'];?> &nbsp;&nbsp;&nbsp;<a class='op' data-toggle="ajaxModal" href="<?php  echo webUrl('util/express', array('id' => $item['ordergoodsid'],'express'=>$refund['rexpress'],'expresssn'=>$refund['rexpresssn']))?>">查看物流</a><br>
