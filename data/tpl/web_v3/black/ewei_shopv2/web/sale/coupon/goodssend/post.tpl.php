                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group col-lg">
                            <select class='form-control '  id="sendnum" name="sendnum" >
                                ...
                                <option value="6" <?php  if($item['sendnum']=='6') { ?> selected<?php  } ?>>6</option>
                                <option value="7" <?php  if($item['sendnum']=='7') { ?> selected<?php  } ?>>7</option>
                                <option value="8" <?php  if($item['sendnum']=='8') { ?> selected<?php  } ?>>8</option>
                                <option value="9" <?php  if($item['sendnum']=='9') { ?> selected<?php  } ?>>9</option>
                                <option value="10" <?php  if($item['sendnum']=='10') { ?> selected<?php  } ?>>10</option>
                            </select>
