...
<div class="page-content">
    <div class="page-sub-toolbar">
            ...
            <?php if(cv('groups.adv.add')) { ?>
                <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('groups/adv/add')?>">添加新幻灯片</a>
            <?php  } ?>
        </span>
    </div>
    <form <?php if( ce('groups.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php  echo $item['id'];?>" />
                ...
                <div class="form-group">
                    ...
                    <label class="col-lg control-label">幻灯片连接</label>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                       ...
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('groups.adv.add|groups.adv.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
