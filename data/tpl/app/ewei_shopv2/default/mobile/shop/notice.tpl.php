...
<script id='tpl_shop_notice' type='text/html'>
	<%each list as notice%>
	<a <%if notice.link !=''%>class="external"<%/if%> href="<%if notice.link !=''%><%notice.link%><%else%><?php  echo mobileUrl('shop/notice/detail')?>&id=<%notice.id%><%/if%>" data-nocache="true" class="notice-item">
		<div class="fui-list">
