...
METUI_FUN['news_list_page_met_16_4'] = {
    name:'news_list_page_met_16_4',
    init: function() {
        var list=METUI['news_list_page_met_16_4'].find('.met-news-list');
        // 产品列表页
        if(list.length){
            // 图片懒加载
            if($('#met-grid').length){
...
METUI['news_list_page_met_16_4'] = new metui(METUI_FUN['news_list_page_met_16_4']);
