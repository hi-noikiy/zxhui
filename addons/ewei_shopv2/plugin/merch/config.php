    ...
    "menu" => array(
        ...
        "items" => array(
            array(
                ...
                "items" => array(
                    array("title" => "申请中", "param" => array("status" => 0)),
                    array("title" => "驳回", "param" => array("status" => -1))
                )
            ),
            array(
                "title" => "商户管理",
                "route" => "user",
                "items" => array(
                    array("title" => "待入驻", "param" => array("status" => 0)),
                    array("title" => "入驻中", "param" => array("status" => 1)),
                    array("title" => "暂停中", "param" => array("status" => 2)),
                    array("title" => "即将到期", "param" => array("status" => 3)),
