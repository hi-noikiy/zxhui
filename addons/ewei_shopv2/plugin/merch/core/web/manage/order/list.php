        ...
        foreach ($list as &$value) {
            ...
            foreach ($order_goods as &$og) {
                ...
                if ($og['is_gift_plus'] === '1') {
                    $merchant = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_merch_user') . ' WHERE id = :id', [':id' => $og['gift_plus_merchid']]);
